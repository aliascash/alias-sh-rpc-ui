...
TEXT_STAKING_ANALYSIS_TIMEFRAME="Analysis time frame for estimation"
TEXT_STAKING_ANALYSIS_AMOUNTS="Staking within the last 1000 transactions"
TEXT_STAKING_ANALYSIS_TOTAL_REWARD="Total reward within the last 1000 transactions"
