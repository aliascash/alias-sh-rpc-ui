...
TITLE_GOODBYE=" 再见"
TITLE_SEND_PUBLIC=" 发送 Public "
TITLE_SEND_PRIVATE=" 发送 Private "
TITLE_CONVERT=" 转换币 "
...
BUTTON_LABEL_PUBLIC_TO_PRIVATE="Public 到 Private"
BUTTON_LABEL_PRIVATE_TO_PUBLIC="Private 到 Public"
...
CMD_MAIN_SEND="发送"
EXPL_CMD_MAIN_SEND="Public 或 Private."
