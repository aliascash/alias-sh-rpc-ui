...
BUTTON_LABEL_JUST_LEAVE="Non, quitter l'interface"
...
EXPL_CMD_USER_COMMAND="Envoi des commandes au démon."
...
#
ERROR_DAEMON_ALREADY_RUNNING="Aliaswalletd (daemon) déjà en cours d'éxécution!\nMais aucune connexion n'a pu être établie.\nCela signifie que le démon vient de démarrer."
ERROR_DAEMON_STARTING="Aliaswalletd arrêté.\nDémarrage Aliaswalletd (démon)..."
ERROR_DAEMON_WAITING_BEGIN="Le démon a besoin de temps pour s'initialiser.\nAttendre 1 minute pour le démon..."
ERROR_DAEMON_WAITING_MSG="secondes restantes..."
ERROR_DAEMON_WAITING_MSG_SUCCESS="Démon connecté.\nTout va bien."
...
#
TEXT_GOODBYE_WARNING="\Z1Avant d'éteindre le système, arrêtez le démon d'abord pour éviter toute corruption de données!\Zn\n\nArrêter le démon (fin du staking) ou juste quitter l'UI?\Zn"
